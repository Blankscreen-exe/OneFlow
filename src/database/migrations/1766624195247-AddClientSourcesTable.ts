...
export class AddClientSourcesTable1766624195247 implements MigrationInterface {
    name = 'AddClientSourcesTable1766624195247'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "users_company_id_fkey"`);
        await queryRunner.query(`CREATE TABLE "client_sources" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying NOT NULL, "name" character varying NOT NULL, "description" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_f30e6eef11d14746e6d62bd2720" UNIQUE ("slug"), CONSTRAINT "PK_b7b0e1bb94ac714e0392d571e2d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "clients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "sourceId" uuid NOT NULL, "name" character varying NOT NULL, "email" character varying, "company" character varying, "phone" character varying, "address" character varying, "notes" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "clients" ADD CONSTRAINT "FK_68d4640cc6b7983282bb1dd9964" FOREIGN KEY ("sourceId") REFERENCES "client_sources"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "clients" DROP CONSTRAINT "FK_68d4640cc6b7983282bb1dd9964"`);
        ...
        await queryRunner.query(`DROP TABLE "client_sources"`);
